        new Vue({
            ...
            methods: {
                ...
                createSealCN(id){
                    ...
                    // 矩形
                    context.lineWidth = 1+this.sealScale06;
                    context.beginPath();
                    context.rect(30*this.sealScale06,60*this.sealScale06,100*this.sealScale06,40*this.sealScale06);  // 定义矩形（x, y, 宽度, 高度）
                    context.stroke();
                    ...
                    for (var i = 0; i < count; i++) {
                        c = chars[i];// 需要绘制的字符   
                        if (i == 0)
                            context.rotate((5.95) * Math.PI / 6 - (count - 1) * (angle - 4 * Math.PI / (3 * count + 10)) / 2) // centered;
                        else
                            context.rotate(angle);
                        context.save();
                        context.translate(60*this.sealScale06 + this.fontBorder01, 0);// 平移到此位置,此时字和x轴垂直   
                    ...
                    context.fillText(this.input03, width - 49*this.sealScale06 + this.fontLeft03*this.sealScale06, height + 47*this.sealScale06 + this.fontTop03*this.sealScale06);
                    // 自定义文字
