        new Vue({
            ...
            methods: {
                ...
                createSeal11(id) {
                    ...
                    var angle = 4 * Math.PI / (3 * count - 5 - this.fontGap01);// 字间角度    0.75 <=> 5.1 调整字间距比例2.5:1
                    ...
                    var angle = 4 * Math.PI / (3 * count - 3 - this.fontGap02);// 字间角度    0.75 <=> 5.1 调整字间距比例2.5:1
                    ...
                    for (var i = 0; i < count; i++) {
                        ...
                        if (i == 0) {
                            ...
                            context.rotate(angle);
                        context.save();
                        context.translate(52*this.sealScale09 + this.fontBorder02, 0);// 平移到此位置,此时字和x轴垂直   
                        context.rotate(Math.PI / 2);// 旋转90度,让字平行于x轴   
                        context.fillText(c, 0, 5);// 此点为字的中心点   
                        context.restore();
                    }
