        new Vue({
            ...
            methods: {
                ...
                createSealCN(id,input01,input02,input03,input04){
                    ...
                    context.beginPath();
                    context.rect(5*this.sealScale07,85*this.sealScale07,290*this.sealScale07+this.borderWidth05,110*this.sealScale07);  // 定义矩形（x, y, 宽度, 高度）
                    context.stroke();
                    context.save();
