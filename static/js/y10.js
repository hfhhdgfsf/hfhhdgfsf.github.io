        new Vue({
            ...
            methods: {
                ...
                createSealCN(id,input01,input02,input03){
                    ...
                    if(this.checked06){
                        context.beginPath();
                        context.rect(canvas.width/2-(42-this.rectLeft06)*this.sealScale08,canvas.height/2-(6-this.rectTop06)*this.sealScale08, (90+this.rectWidth06)*this.sealScale08, (20+this.rectHeight06)*this.sealScale08);  // 定义矩形（x, y, 宽度, 高度）
