        new Vue({
            ...
            methods: {
                ...
                // 设置尺寸大小时，计算出相应的倍数
                sizeChange() {
                    this.sealScale06 = this.sealSize06 / 100
                    this.setChange()
                },
                // 绘制中文印章
                createSealEx2() {
                    ...
                    sealdiv.innerHTML = `<div class="relative">
                            ...
                            <div class="absolute flex flex-wrap" style="user-select: none;pointer-events: none;width: 100%;height: 100%;top: 0;z-index: 999;color: rgba(127,127,127,.4);font-size: ${12*this.sealScale06}px;">
                ...
                createSealCN(id){
                    ...
                    context.beginPath();
                    context.arc(width, height, 46*this.sealScale06, 0, Math.PI * 2);
                    context.stroke();
                    context.save();
                    ...
                    context.beginPath();
                    context.moveTo(5*this.sealScale06, 40*this.sealScale06);
                    context.lineTo(95*this.sealScale06, 40*this.sealScale06);
                    context.moveTo(5*this.sealScale06, 60*this.sealScale06);
                    context.lineTo(95*this.sealScale06, 60*this.sealScale06);
                    context.stroke();
                    ...
                    context.fillText(this.input01, width - 14*this.sealScale06 + this.fontLeft01*this.sealScale06, height - 20*this.sealScale06 + this.fontTop01*this.sealScale06);
                    // 中心文字
                    context.font = this.fontWeight02 + ' ' + this.fontSize02*this.sealScale06 + 'px ' + this.fontFamily02
                    context.fillText(this.input02, width - 33*this.sealScale06 + this.fontLeft02*this.sealScale06, height + 6 *this.sealScale06 + this.fontTop02*this.sealScale06,65*this.sealScale06+this.fontGap02);
                    // 下文字
                    context.font = this.fontWeight03 + ' ' + this.fontSize03*this.sealScale06 + 'px ' + this.fontFamily03
                    context.fillText(this.input03, width - 25*this.sealScale06 + this.fontLeft03*this.sealScale06, height + 35*this.sealScale06 + this.fontTop03*this.sealScale06);
