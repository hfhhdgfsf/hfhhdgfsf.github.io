       new Vue({
            ...
            methods: {
                ...
                createSealCN(id){
                    ...
                    // 竖线
                    context.moveTo(40*this.sealScale06, 96*this.sealScale06);
                    context.lineTo(40*this.sealScale06, 143*this.sealScale06);
                    context.moveTo(200*this.sealScale06, 96*this.sealScale06);
                    context.lineTo(200*this.sealScale06, 143*this.sealScale06);
                    context.stroke();
                    ...
                    context.fillText(this.input03, width - 62*this.sealScale06 + this.fontLeft03*this.sealScale06, height + 59*this.sealScale06 + this.fontTop03*this.sealScale06);
                    
                    context.font = 'bold ' + 20*this.sealScale06 + 'px 宋体' 
                    context.fillText('生',12*this.sealScale06,115*this.sealScale06)
                    context.fillText('效',12*this.sealScale06,135*this.sealScale06)
                    context.fillText('日',206*this.sealScale06,115*this.sealScale06)
                    context.fillText('期',206*this.sealScale06,135*this.sealScale06)
